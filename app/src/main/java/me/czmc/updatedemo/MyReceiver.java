...
import me.czmc.library.core.Update;
...
//        	打开自定义的Activity
			...
			UpdateInterface.setOnCheckListenr(new Update.OnCheckListener() {
				@Override
				public void checkUpdate(CheckResult result) {
					if(result.isSuccessed()){
						if (AppUtils.getVersionCode(context) < result.versionCode) {
							UpdateInterface.goToDownload(context,result.downloadUrl,UpdateInterface.TYPE_FROM_NOTIFY);
